...
export default class Consola {
  static tabsUsedInChain = 0;
  static isTracingOn = false;
  ...
  static set traceMode(mode) {
    this.isTracingOn = mode;
  }

  static get traceMode() {
    return this.isTracingOn;
  }

  static trace(message, traceRequired = false) {
